<div class="page--padding">
    ...
    <div class="row">
        ...
        ?>
            ...
            <div href="index.php?ctrl=video&action=showVideosByCategory&id_cat=<?php echo $category->getId() ?>">
                <div class="small-12 columns category-box">
                    <div class="category-title">

                        <form method="post" action="index.php?ctrl=user&action=modification">
                            <?php echo '<input type="text" value="'.$category->getName().'". id="'.$category->getId().'". name="'.$category->getId().'"/>'; ?>
                            <input type="submit">
                        </form>
...
<!-- <form method="post" action="index.php?ctrl=user&action=inscription">
