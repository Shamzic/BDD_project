...
<?php
	foreach($sharedNotesWithMe as $note)
	{
		...
		<div style="border:1px solid black;width:30%;">
			...
			<p style="margin-top:5px;margin-bottom:0;padding-left:5px;"><a href="index.php?ctrl=note&action=editNote&id=<?php echo $note['id'];?>"><img src="images/editer.png"></a>
			<a href="index.php?ctrl=note&action=deleteNote&id=<?php echo $note['id'];?>"><img src="images/supprimer.png"></a></p>
